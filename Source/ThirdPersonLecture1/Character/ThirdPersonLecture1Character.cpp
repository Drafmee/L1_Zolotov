...
AThirdPersonLecture1Character::AThirdPersonLecture1Character()
{
...
void AThirdPersonLecture1Character::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AThirdPersonLecture1Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AThirdPersonLecture1Character::Move);
...
void AThirdPersonLecture1Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AThirdPersonLecture1Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
{
	TArray<USpawner*> Components;

	GetComponents<USpawner>(Components);

	Components[0]->SpawnProjectile(1);	
}
void AThirdPersonLecture1Character::FireSparks()
{
	...
	Components[0]->SpawnProjectile(2);
}
void AThirdPersonLecture1Character::FireFirestorm()
{
	...
	Components[0]->SpawnProjectile(3);
}		
